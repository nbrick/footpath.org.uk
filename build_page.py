...
DONE = {
    ...
    "Caerphilly": "https://www.caerphilly.gov.uk/things-to-do/green-spaces/public-rights-of-way/report-a-problem-with-a-public-right-of-way",
    "Calderdale": "https://new.calderdale.gov.uk/streets-and-transport/public-rights-way/rights-way-improvements",
    ...
    "Solihull": "https://www.solihull.gov.uk/sports-fitness-and-leisure/walking/public-rights-way",
    ...
    "Stockport": "https://www.stockport.gov.uk/public-rights-of-way-map",
    ...
    "Swansea": "https://www.swansea.gov.uk/rightofwayproblem",
...
DESC = {
    ...
    "Caerphilly": "Report page — form, or phone if it&rsquo;s urgent",
    "Calderdale": "Rights-of-way page — email or contact form",
    ...
    "Solihull": "Rights-of-way page — links to the report form",
    ...
    "Stockport": "Rights-of-way map — find the path number, then get in touch",
...
<div class="wrap">
  ...
  <div class="controls">
    <input id="filter" class="filter" type="search" name="authority" inputmode="search"
           ...
           enterkeyhint="search" placeholder="Start typing the council or county&hellip;">
  </div>
